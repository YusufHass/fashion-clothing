...
/* the following code changes from useContext to useReducer
The the code voids the useState and uses state and action to manage
 the data
...
export const CartProvider = ({ children }) => {
  ...
  //the following code implemets the dispatch to
  //the reducer and distructure the props instead ofusing useEffect
